  ...
  try {
    const mousesCategory = await prisma.category.create({
      data: {
        name: "Mouses",
        slug: "mouses",
        imgUrl: "https://fsw-store.s3.sa-east-1.amazonaws.com/mouses.png",
      },
    });
    ...
    const keyboardsCategory = await prisma.category.create({
      data: {
        name: "Teclados",
        slug: "keyboards",
        imgUrl: "https://fsw-store.s3.sa-east-1.amazonaws.com/keyboards.png",
      },
    });
    ...
    const headphonesCategory = await prisma.category.create({
      data: {
        name: "Fones",
        slug: "headphones",
        imgUrl: "https://fsw-store.s3.sa-east-1.amazonaws.com/headphones.png",
      },
    });
    ...
    const mousepadsCategory = await prisma.category.create({
      data: {
        name: "Mousepads",
        slug: "mousepads",
        imgUrl: "https://fsw-store.s3.sa-east-1.amazonaws.com/mousepads.png",
      },
    });
    ...
    const monitorsCategory = await prisma.category.create({
      data: {
        name: "Monitores",
        slug: "monitors",
        imgUrl: "https://fsw-store.s3.sa-east-1.amazonaws.com/monitors.png",
      },
    });
    ...
    const speakersCategory = await prisma.category.create({
      data: {
        name: "Speakers",
        slug: "speakers",
        imgUrl: "https://fsw-store.s3.sa-east-1.amazonaws.com/speakers.png",
      },
    });
